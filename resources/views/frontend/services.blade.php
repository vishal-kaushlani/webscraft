...
@section('content')
        ...
        <!-- Services Start -->
        <section class="serviceSection02 spPage">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2 class="secTitle">Digital Service</h2>
                        <p class="secDesc">
                            Our versatile team is built of designers, developers and digital<br> marketers who all bring unique experience
                        </p>
                    </div>
                </div>
                <div class="row">
        ...
        <section class="serviceSection04">
            <div class="SecLayerimg move_anim2">
                <img src="assets/images/bg/s12.png" alt="">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="serviceItem04">
                            <div class="serImg">
                                <img src="assets/images/service/8.png" alt=""/>
                            </div>
                            <h3><a href="single-service.html">Web Design</a></h3>
                            <p>Digital marketing reaches targeted audience in an affordable and measurable way</p>
                            <a class="srmore" href="single-service.html"><i class="dgita-arrow"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="serviceItem04">
                    ...
                    <div class="col-lg-6">
                        <div class="serviceItem04">
                            ...
                            <h3><a href="single-service.html">Idea & Research</a></h3>
                            <p>Digital marketing reaches targeted audience in an affordable and measurable way</p>
                            <a class="srmore" href="single-service.html"><i class="dgita-arrow"></i></a>
                        </div>
                    </div>
        ...
        <!-- Progress Start -->
        <section class="progressSection04">
            <div class="SecLayerimg move_anim">
                <img src="assets/images/bg/s28.png" alt="">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
        ...
        <!-- Work Process Start -->
        <section class="wordProcessSection01 abPS3 spwps">
            <div class="SecLayerimg move_anim">
