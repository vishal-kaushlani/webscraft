...
define('SUBJECT', 'Dgita User Query');
define('FROM_EMAIL', $form['con_email']);

$MESSAGE = 'Hi Admin, <br/><br/>';
$MESSAGE .= 'You got an user query from Dgita. User details and Message are noted bellow: <br/><br/>';
...
if(isset($form['con_url']) && $form['con_url'] != ''):
    $MESSAGE .= 'Url : '.$form['con_url'].'<br/>';
endif;
if(isset($form['select_time']) && $form['select_time'] != ''):
    $MESSAGE .= 'Time : '.$form['select_time'].'<br/>';
endif;
